...
# Test if server is running by checking the root endpoint
try {
...
try {
    ...
    Write-Host "Login successful: $($loginResponse | ConvertTo-Json)"
...
try {
    ...
    Write-Host "Book creation successful: $($bookResponse | ConvertTo-Json)"
...
try {
    ...
    Write-Host "Books retrieval successful: $($booksResponse | ConvertTo-Json)"
